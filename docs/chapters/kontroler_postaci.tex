...
zamapowane odpowiednie klawisze dla każdej z osi wzdłuż której gracz może przemieszczać się. W rezultacie powstały dwa
...
względem kierunku w który jest zwrócona oraz modyfikowane jest jej położenie. Dodatkowo, ten komponent odpowiada za
