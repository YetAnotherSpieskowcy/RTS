...
\begin{itemize}
    ...
    \item stan zdrowia gracza, aby zasygnalizować mu;
...
\begin{figure}[htbp]
    ...
    \caption{Implementacja ikony zadania do wykonania
    }\label{fig:wyq}
\end{figure}
...
"Wciśnij jakiś klawisz, żeby stało się coś". To, że zadanienie zostało jeszcze wykonane sygnallizuje czerwony wykrzyknik w przwym, górnym rogu notatki. Gracz może 
