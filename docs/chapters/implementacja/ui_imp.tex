...
jednak są nie tylko ludzie, ale i surowce, które można zbierać. Jeśli możliwa jest interakcja,  wyświetlana jest informacja o takim stanie
 ...
 \begin{figure}[htbp]
    \centering
    \subfloat[Implementacja grafiki informującej o możliwości rozpoczęcia rozmowy.]{\includegraphics[width=0.4\textwidth]{images/ui/interakcja_rozmowa.png}\label{fig:rozmow}}
    \qquad
    \subfloat[Implementacja grafiki informującej o możliwości podniesienia przedmiotu.]{\includegraphics[width=0.4\textwidth]{images/ui/interakcja_podnies.png}\label{fig:przedmio}}
...
Funkcjonalność jednak nie została ukończona w zaplanowanym czasie i wymaga poprawek, aby działać w oczekiwany sposób w zadowalającym stopniu. Zdecydowano
o niedołączaniu mechaniki do finalnego programu, zostawiając ją jako możliwy dodatek w przyszłym rozwoju gry.
\begin{figure}[htbp]
    \centering
