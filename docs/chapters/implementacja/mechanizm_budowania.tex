...
\begin{figure}[h!]
    \begin{subfigure}
      \centering
      \includegraphics[width=.8\textwidth]{images/implementacja/mechanizm_budowania/gizmos_drzeow_2.png}
      \caption{Widok z góry.}
    \end{subfigure}
    \begin{subfigure}
      \centering
      \includegraphics[width=.8\textwidth]{images/implementacja/mechanizm_budowania/gizmos_drzeow_1.png}
