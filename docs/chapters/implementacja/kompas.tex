...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1.0\textwidth]{images/ui/opis_ekementow_kompasu.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ui/compass.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{images/ui/strony_swiata.png}
