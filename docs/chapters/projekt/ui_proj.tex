...
\end{itemize}
Inspiracją dla górnego paska z informacjami jest ten użyty w grze \textit{Warcraft 3} (por. \ref{c:elem_ui}). Prostota i surowość stylu będą współgrać z klimatem gry.
...
Jako ważny element tej części UI zawarty zostanie kompas, wzorowany na tym z gry \textit{The Elder Scrolls V: Skyrim} (por. \ref{chap:skrm}).
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ui/ui_proj_ogolne.jpg}
...
nie można będzie dokonać zakupu, czy postawienia. Inspiracją do przedstawienia tych informacji zostanie rozwiązanie gry \texttt{Orcs must die!} (por. \ref{c:elem_ui}).
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ui/ui_proj_budowanie.jpg}
...
Źródłem pomysłu jest interfejs zaprojektowany w grze \textit{Mount\&Blade} (por. \ref{chap:mb}).

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ui/ui_proj_walka.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ui/ui_proj_zapis.jpg}
    \caption{Projekt menu zapisu.}\label{fig:men_zap}
\end{figure}
\FloatBarrier

\subsection{Informacja o możliwej interakcji}
W programie przewidziane są postacie i przedmioty interaktywne. Aby zasygnalizowć graczowi zaistniałą możliwość podjęcia pewnej akcji,
...
pod bazowym interfejsem.
    \begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ui/ui_prooj_interakcja.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ui/ui_proj_dziennik_zadan.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\textwidth]{images/ui/ui_prooj_koniec_gry.jpg}
