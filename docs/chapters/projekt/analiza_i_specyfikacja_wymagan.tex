...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9]{images/diagrams/usecase.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9]{images/diagrams/state.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.9]{images/diagrams/class.png}
