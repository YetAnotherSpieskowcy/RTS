...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1.0]{images/diagrams/usecase.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1.0]{images/diagrams/state.png}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1.0]{images/diagrams/class.png}
