...
\begin{figure}[htbp]
    ...
    \caption{Prawa część paska z informacjami w grze \textit{Warcraft 3}.}\label{fig:Warcraft3}
\end{figure}
...
\begin{figure}[h!tbp]
    ...
    \caption{Wyświetlenie dostępnych pułapek w grze \textit{Orcs must die!}.}\label{fig:Orcs}
\end{figure}