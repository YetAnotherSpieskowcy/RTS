...
poziom inteligencji i umiejętności, które pozwalają jej przeanalizować konkretną sytuacje i wyciągnąć wnioski.Skoro więc te informacje są w zasięgu możliwości wnioskowania postaci, gra ma prawo wyświetlić je użytkownikowi. 
...
jednocześnie okrawając je tak, aby nie przytłaczały gracza i nie zaciemniały przekazu.
