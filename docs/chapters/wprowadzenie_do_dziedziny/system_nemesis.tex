\section{Fabuła w grach RTS (Bogna Lew)}\label{s:fabuła}
...
narracja, która definiuje kolejność występowania elementów fabuły. W odróżnieniu od narracji budującej
...
można opisać z dużą autorską kontrolą"\cite{understanding_games}. Stanowią one ciekawe urozmaicenie w rozgrywce i
